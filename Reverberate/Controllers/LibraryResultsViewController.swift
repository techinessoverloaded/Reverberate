...
class LibraryResultsViewController: UITableViewController {
    ...
    private lazy var initialMessage: NSAttributedString = {
        ...
        var mutableAttrString = NSMutableAttributedString(string: "Find your favourites\n\n", attributes: largeTextAttributes)
        mutableAttrString.append(NSMutableAttributedString(string: "Search everything you've liked or created.", attributes: smallerTextAttributes))
...
extension LibraryResultsViewController: UISearchResultsUpdating
{
